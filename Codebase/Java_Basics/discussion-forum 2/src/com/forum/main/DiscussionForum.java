...
public class DiscussionForum {
  ...
  public static void main(String args[]) throws IOException {
    ...
    userActivity.userService.createUser("moderate", "moderate", "moderate", UserRole.MODERATOR);
    userActivity.userService.createUser("regular", "regular", "regular", UserRole.USER);
    while (true) {
  ...
  public static void menu(User user, UserActivity userActivity)
    ...
    while (true) {
      ...
      System.out.println("\n Enter your choice");
      if (!classifyMenuChoice(Integer.parseInt(Utility.inputFromUser()), userActivity, user)) break;
    }
  }

  public static boolean classifyMenuChoice(int choice, UserActivity userActivity, User user)
      throws IOException {
  ...
  public static boolean processQuestionChoice(int choice, UserActivity userActivity, User user)
      throws NumberFormatException, IOException {
    while (true) {
      switch (choice) {
        case 1:
  ...
  public static void replyMenu(UserActivity userActivity, User user, Question question)
      throws NumberFormatException, IOException {
    while (true) {
      int menuIndex = 0;
      ...
      System.out.println("\n Enter your choice");
      if (!processReplyChoice(
          Integer.parseInt(Utility.inputFromUser()), userActivity, user, question)) {
        break;
      }
    }
  }

  public static boolean processReplyChoice(
      int choice, UserActivity userActivity, User user, Question question)
      throws NumberFormatException, IOException {
    while (true) {
      switch (choice) {
        case 1:
